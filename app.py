...
password = 'sparta'
cxn_str = f'mongodb+srv://test:{password}@cluster0.oncvg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
def delete_ex():
    ...
    return jsonify({'result': 'success','msg': f'your example fot the word,{word}, was delete!'})
